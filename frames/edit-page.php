...
<? endif; ?>
      ...
      data-scripts="ace jquery colors editor editor-tools editor-tools/text-formatting editor-tools/save editor-tools/link editor-tools/page-options editor-tools/revision token-list diff2html colorpicker"
